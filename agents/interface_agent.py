...
class InterfaceAgent:
    ...
    def analyze_file(self, data):
        ...
        Your analysis should be summarized in the shortest possible way to convey the most important information in less than 100 words. 
        """
